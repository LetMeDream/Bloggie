...
# Could be seen as the 'LoginSerializer'
class MyTokenObtainPairSerializer(TokenObtainPairSerializer):
  ...
  def get_token(cls, user):
    ...
    print(f"User Full Name: {user.full_name}, Email: {user.email}, Username: {user.username}")
    print(token)
    try:
...
# Define a Extended serializer for the Profile 
...
# Define a Extended serializer for the User 
